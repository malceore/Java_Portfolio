...
import cscie97.asn4.housemate.controller.HouseMateController;
import cscie97.asn4.housemate.controller.Observer;
...
public class HouseMateModel {
    private static HouseMateModel instance = new HouseMateModel();
     ...
     * @param UUID2
     */
    public void setAssociation(String UUID1, String UUID2){
     ...
     * @param UUID2
     */
    public void removeAssociation(String UUID1, String UUID2){
        try {
            // If value already has a setting we should remove it.
    ...
    public void setValue(String[] owner, String valueType, String value){
        ...
        for (Object nameEntry : nameSet) {
            Triple nameTrip = (Triple) nameEntry;
            nam = nameTrip.getIdentifier().split(" ");
        }
     ...
     * @param value
     */
    public void setValue(String UUID, String valueType, String value){
        // If value already has a setting we should remove it.
        Set results = valueGraph.executeQuery(UUID, valueType, "?");
        for(Object entry: results) {
            valueGraph.removeTriple((Triple) entry);
     ...
     * @param value
     */
    public void removeValue(String UUID, String valueType, String value){
        try {
            // If value already has a setting we should remove it.
